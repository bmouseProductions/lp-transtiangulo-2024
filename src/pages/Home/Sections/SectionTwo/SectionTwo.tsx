                ...
                <div className="relative mt-12 mb-2.5 w-full max-w-[1078px] max-md:mt-10 max-md:max-w-full">
                    <div className="flex gap-5 max-md:flex-col max-md:gap-0">
                        <div className="flex flex-col w-6/12 max-md:ml-0 max-md:w-full">
                            <div className="flex relative flex-col self-stretch my-auto  text-white">
                                <h1 className='text-3xl  lg:text-5xl italic'>
                                    HÁ MAIS DE 19 ANOS
                                    NO MERCADO
                                </h1>

                                <div className="mt-10 md:mt-16 text-lg !font-normal">
                        ...
                        <div className="flex flex-col ml-5 w-6/12 max-md:ml-0 max-md:w-full">
                            <img
                                loading="lazy"
                                src={colaborador}
                                className=" grow md:grow-0 lg:grow w-full aspect-[0.65] max-md:mt-10 max-md:max-w-full"
