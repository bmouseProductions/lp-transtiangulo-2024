            ...
            <div >
                <div className="flex overflow-hidden relative flex-col items-center md:px-10 lg:px-16 pt-20 pb-7 w-full mix-blend-hard-light lg:min-h-[648px] max-md:px-5 max-md:max-w-full bg-[#df7f0d] ">
                    ...
                    >
                        <img
                            loading="lazy"
                            src="https://cdn.builder.io/api/v1/image/assets/TEMP/8aae7d7e3bfd175bdbb245db8f191279cdf3ec259842a81f3fe397bb1f908697?apiKey=f3f6ab0d16cf4f10881b61c4cf8dd438&"
                            className="w-full aspect-[7.14] max-md:max-w-full"
                        />
                        <div className="mt-11 md:text-xl  text-center text-white  max-md:mt-10 max-md:max-w-full">
                            Há 19 anos no mercado, atuando no setor de transportes e logística, a Transtriângulo destaca-se principalmente pelo comprometimento com seus clientes, não só com uma prestação de serviços com qualidade, mas também por fazer do compromisso o nosso melhor caminho.
                        </div>
